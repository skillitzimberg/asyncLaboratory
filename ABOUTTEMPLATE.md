...
```
dotnet new --install [ /Users/Your/Path/Here ]/asyncLaboratory
```
...
```
dotnet new --install /Users/Guest/Desktop/asyncLaboratory
```
...
```
dotnet new asyncLaboratory -n [ YourProjectName ]
```
For example: If your project is called Banana the command would be:
```
dotnet new asyncLaboratory -n Banana
```
